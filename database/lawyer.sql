...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 30, 2024 at 05:35 PM
...
INSERT INTO `lawyer` (`id`, `name`, `last name`, `email`, `number`, `address`, `password`, `bar council`, `since`, `specialist`, `description`, `degree`, `university`, `language`, `day`, `Time`, `fee`, `image`, `cover image`, `about me`) VALUES
