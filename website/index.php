...
?>
	...
	<div id="colorlib-practice">
		<div class="container">
			...
			<a href="cat_wise_lawyer.php?id=<?php echo $data['cat_id']; ?>">
			<div class="row">
				<div class="col-md-4 text-center animate-box">
					<div class="services">
						...
						<div class="desc">
							<h3><a ><?php echo $data['cat_name'] ?></a></h3>
				...
				<div class="col-md-12 text-center animate-box">
					<p><a class="btn btn-primary btn-lg btn-learn" href="lawyer.php">View More <i class="icon-arrow-right"></i></a></p>
				</div>
			</div>
		</div>
	</div>
