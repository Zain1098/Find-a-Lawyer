                        ...
                        <ul>
                            ...
                            <?php if ($user_info): ?>
                                <li class="has-dropdown">
                                    <?php if ($_SESSION['user_type'] == 'lawyer' && !empty($user_info['image'])): ?>
                                        <a href="#"><img src="./Login&Singup/Lawyer Singup/uploads/<?php echo $user_info['image'] ?>" alt="Profile Image" class="profile-img"></a>
                                    <?php else: ?>
