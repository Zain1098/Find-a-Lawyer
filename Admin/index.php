...
echo '<script>window.location.href = "./Signup/login_email.php";</script>';
}
?>
        ...
        <div class="row">
                ...
                <div class="card">
                    <div class="stat-widget-two card-body">
                        <div class="stat-content">
                            ...
                            $sql = "SELECT COUNT(*) AS id FROM role";
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="card">
                    <div class="stat-widget-two card-body">
                        <div class="stat-content">
                            <div class="stat-text">Total Lawyers</div>
                            <?php

                            $sql = "SELECT COUNT(*) AS id FROM lawyer";
                            $result = mysqli_query($con, $sql);
                ...
                <div class="card">
                    <div class="stat-widget-two card-body">
                        <div class="stat-content">
                            ...
                            $sql = "SELECT COUNT(*) AS id FROM categorie";
                            $result = mysqli_query($con, $sql);
